...
for my $case (
    ...
    [ [ qw{COMMAND GETKEYS EVAL "not consulted" 3 key1 key2 key3 arg1 arg2 arg3 argN} ] => [ qw{} ] ],
    ...
    [ [ qw{SET mykey "Hello"} ] => [ qw{mykey} ] ],
    [ [ qw{GET mykey} ] => [ qw{mykey} ] ],
    [ [ qw{SET anotherkey "will expire in a minute" EX 60} ] => [ qw{anotherkey} ] ],
    ...
    [ [ qw{ZRANK myzset "three" WITHSCORE} ] => [ qw{} ] ],
    [ [ qw{ZRANK myzset "four" WITHSCORE} ] => [ qw{} ] ],
    [ [ qw{ZADD myzset 1 "one"} ] => [ qw{myzset} ] ],
    [ [ qw{ZADD myzset 2 "two"} ] => [ qw{myzset} ] ],
    [ [ qw{ZADD myzset 3 "three"} ] => [ qw{myzset} ] ],
    ...
    [ [ qw{ZREVRANK myzset "three" WITHSCORE} ] => [ qw{} ] ],
    [ [ qw{ZREVRANK myzset "four" WITHSCORE} ] => [ qw{} ] ],
    [ [ qw{ZADD myzset 1 "one"} ] => [ qw{myzset} ] ],
